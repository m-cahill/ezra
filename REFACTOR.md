...
**Validated CI (merge review):** run `25468913909` @ `237451b9fbd68143cda7d3a26426ec76db190353` — workflow **success**; only **Dependency Review** fails (settings/GHAS). If PR head advances, re-run `gh pr view 39` and confirm a green CI run with the same pattern before merge.
