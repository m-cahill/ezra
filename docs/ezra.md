...
| M37 | Public Release Boundary Cleanup | In progress — Pending CI | — | PR#40 | Removes only approved company-secret paths from Git tracking and adds guardrail. No runtime, EPB, dependency, or workflow behavior changes. See `docs/milestones/M37/M37_plan.md`. |
