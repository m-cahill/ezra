...
| M40 | Public Release Operation / Visibility Decision | Planning documented | — | — | Plan repo visibility (`m-cahill/ezra`), optional tag/release after approval, post-operation evidence after M39 **GO WITH DOCUMENTED LIMITATIONS**. Pages/SLSA/Dependency Review as decision points; no operation executed yet. `docs/milestones/M40/M40_plan.md`. |
