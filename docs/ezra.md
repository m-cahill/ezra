...
| M40 | Public Release Operation / Visibility Decision | Planning complete — pending merge review | — | PR#44 | Planning-only operational path for repo visibility, optional tag/release orchestration, post-operation evidence, and documented limitations. No operation executed. |
