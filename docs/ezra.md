...
| M38 | Audit-Polish / Public-Readiness Improvements | Implementation complete — pending PR/CI | — | — | CONTRIBUTING, `docs/release/PUBLIC_RELEASE_CHECKLIST.md`, README polish; `ezra_version` from package metadata + `v` prefix for schema; `tests/test_ezra_version_manifest.py`. No EPB schema/canonicalization/hashing change. Proof: `docs/milestones/M38/M38_plan.md`, `M38_run1.md`. |
