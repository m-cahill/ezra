...
| M37A | Required Gate Recovery for Public Release | Planning | — | — | Planning-only recovery for post-M36 red gates: `pip-audit`, Distribution Verification HTTP 401, Dependency Review availability, SLSA provenance limitations. No runtime or EPB changes. See `docs/milestones/M37A/M37A_plan.md`. |
