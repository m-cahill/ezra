...
| M41 | Public Repo Post-Visibility Smoke | Planning only — execution deferred | — | — | Observe public PR CI and **Dependency Review** after M40; docs-only smoke PR on **`docs/m41-post-visibility-smoke`**, **merge if green**; no tag/release/PyPI/Pages/settings/workflows/runtime/EPB/boundary changes. Plan: `docs/milestones/M41/M41_plan.md`. M39 **GO WITH DOCUMENTED LIMITATIONS** unchanged. Optional next: **M42** tag/GitHub Release only if authorized. |
