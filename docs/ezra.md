...
| M35 | EZRA Operating Manual (AI-Agent Ready) | Complete | — | PR#36 | Merge `457afb8`. EZRA Operating Manual v1.0.0 established as AI-agent-usable runtime specification; behavior preserved. Artifacts: `docs/ezra_operating_manual_v1.md`, `docs/certification/README.md`, M35 proof pack. Mechanical CI: Ruff E501 + format (`scripts/verify_distribution.py`, `tests/test_distribution_verification.py`). EPB/spec/plugin contracts unchanged. CI Runs: 23362721199, 23362812040, 23362922215 — Distribution Verification fails with HTTP 401 (artifact token/permissions; infra, not M35 regression); required gates green on final PR head. |
| M36 | Audit Reconciliation & Public Release Boundary Inventory | Complete | — | PR#37 | Squash merge `9694710` to `main`. Evidence-only: reconciliation doc, `REFACTOR.md`, secret-path inventory, M37 stubs, `M36_pr1_ci_triage.md`, `M36_merge.md`. No runtime, EPB schema, workflow, dependency, or `.gitignore` changes. Post-merge CI still red on pre-existing infra/SCA (see `M36_merge.md`). Verdict: Closed — Proceed to M37; recommend M37A-style gate recovery before public-release green. |
| M37A | Required Gate Recovery for Public Release | Complete | — | PR#38 | Squash merge `266f398` to `main`. Planning-only; evidence `M37A_plan.md` / `M37A_run1.md`; closeout `M37A_summary.md`, `M37A_audit.md`; merge record `M37A_merge.md`. Post-merge CI run 25467827609 — known reds (Security/`pip-audit`, Distribution Verification, SLSA, Docs Deploy); Dependency Review skipped on push. M37B next. |
| M37B | Required Gate Recovery Implementation | Complete | — | PR#39 | Squash merge to `main` @ `a51b6c0`. Gate recovery: `pip-audit`, `ci-local` / `release` distribution verification, honest SLSA/Pages, `types-jsonschema`. Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25470570460 — **success**. **Dependency Review** skipped on `push` to `main`; still unsupported on PR until GHAS/dependency graph. Record: `docs/milestones/M37B/M37B_merge.md`. **M37 — Public Release Boundary Cleanup** next. |
| M37 | Public Release Boundary Cleanup | Complete | — | PR#40 | Squash merge to `main` @ `9adfe7a`. Removed only three tracked `docs/enhancements/*.md`; `git ls-files .cursorrules docs/enhancements docs/prompts` **empty**; guardrail `tests/test_public_release_boundary.py`. Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25473078293 — **success**. **Dependency Review** skipped on `push`. Record: `docs/milestones/M37/M37_merge.md`. **M38** next. |
| M38 | Audit-Polish / Public-Readiness Improvements | Complete | — | PR#41 | Squash merge to `main` @ `ab0d07e`. CONTRIBUTING, `docs/release/PUBLIC_RELEASE_CHECKLIST.md`, README polish; `ezra_version` from package metadata + `v` prefix; `tests/test_ezra_version_manifest.py`. Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25479475613 — **success**. Record: `docs/milestones/M38/M38_merge.md`. **M39** next. |
| M39 | Final Public-Release Audit / Release Readiness Decision | Complete | — | PR#43 | Squash merge to `main` @ `5449b5a`. **GO WITH DOCUMENTED LIMITATIONS** (`docs/milestones/M39/M39_public_release_audit.md`). Audited HEAD `2f78201`; evidence `M39_run1.md`, `M39_summary.md`, `M39_audit.md`. Plan PR#42 @ `bd8a27f`. Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25483563138 — **success**. Record: `docs/milestones/M39/M39_merge.md`. |
| M40 | Public Release Operation / Visibility Decision | Public visibility complete / tag-release deferred | — | PR#45 @ `ac18a7e` | Repo **public** at https://github.com/m-cahill/ezra. Planning merged PR#44 @ `ddb678e`; visibility evidence squash-merge `ac18a7ebbe806c098223d055a3b07fb342be791d` (PR #45, head `44d34881a7f762a49669e1f1d3546d51710987f0`). Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25529262946 — **success**; merge-record commit `43e76f6be859cc8b5bdf51bba26aeb5b8d7f83db` CI https://github.com/m-cahill/ezra/actions/runs/25529330764 — **success**. Records: `M40_plan_merge.md`, `M40_run1.md`, `M40_visibility_record.md`, **`M40_visibility_merge.md`**. Tag / GitHub Release / PyPI / Pages **deferred** pending separate approval. |
| M41 | Public Repo Post-Visibility Smoke | Planning merged / Smoke execution pending | — | PR#46 @ `9343044` | Planning squash-merge `934304433043f5e161066a47c50d65ca9f248dfd` (head `648d80b0cbe8a8efba39f3281890aee051f1f703`). Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25535849971 — **success**. Merge-record commit `365d9c149d0187820925540be2c90d5f0fdff001` CI https://github.com/m-cahill/ezra/actions/runs/25535906017 — **success**. Record: **`docs/milestones/M41/M41_plan_merge.md`**. PR **#46**: Dependency Review **failed** (known GHAS/dependency-graph class); `main` push: Dependency Review **skipped**. Execute smoke on **`docs/m41-post-visibility-smoke`** when authorized. M39 **GO WITH DOCUMENTED LIMITATIONS** unchanged. |
