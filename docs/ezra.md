...
| M40 | Public Release Operation / Visibility Decision | Planning merged — execution requires explicit approval | — | PR#44 @ `ddb678e` | Squash merge to `main`; post-merge CI https://github.com/m-cahill/ezra/actions/runs/25526915472 — **success**. Record `docs/milestones/M40/M40_plan_merge.md`. No visibility/tag/release/Pages yet. |
