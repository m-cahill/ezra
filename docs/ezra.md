...
| M37B | Required Gate Recovery Implementation | Planned | — | — | Implementation: lockfile/`pip-audit`, Distribution Verification 401/scoping, SLSA honesty, Pages/deploy. See `docs/milestones/M37B/M37B_plan.md`. M37 remains deferred until gate recovery is resolved or accepted. |
