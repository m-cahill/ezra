...
| M37A | Required Gate Recovery for Public Release | Closed | — | PR#38 | Planning-only; evidence in `M37A_plan.md` / `M37A_run1.md`; closeout `M37A_summary.md`, `M37A_audit.md`. No runtime, workflow, dependency, schema, or secret-cleanup changes. Same known CI reds on PR head until M37B. |
