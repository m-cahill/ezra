...
| M38 | Audit-Polish / Public-Readiness Improvements | Planned | — | — | Small behavior-preserving polish after public-boundary cleanup: likely CONTRIBUTING, package version metadata, release/docs clarity, and final public-release audit prep. Scope to be planned separately. |
