...
| M39 | Final Public-Release Audit / Release Readiness Decision | Planned | — | — | Run a fresh public-release audit on the current tree after M36–M38 reconciliation, gate recovery, boundary cleanup, and polish. Decide release go/no-go with evidence (not historical score assumptions). |
