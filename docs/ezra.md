...
| M41 | Public Repo Post-Visibility Smoke | Planning merged / Smoke execution pending | — | PR#46 @ `9343044` | Planning squash-merge `934304433043f5e161066a47c50d65ca9f248dfd` (head `648d80b0cbe8a8efba39f3281890aee051f1f703`). Post-merge `main` CI https://github.com/m-cahill/ezra/actions/runs/25535849971 — **success**. Record: **`docs/milestones/M41/M41_plan_merge.md`**. PR **#46**: Dependency Review **failed** (known GHAS/dependency-graph class); `main` push: Dependency Review **skipped**. Execute smoke on **`docs/m41-post-visibility-smoke`** when authorized. M39 **GO WITH DOCUMENTED LIMITATIONS** unchanged. |
