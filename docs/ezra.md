...
| M40 | Public Release Operation / Visibility Decision | Planning merged; visibility-only execution done — tag/release separate | https://github.com/m-cahill/ezra | PR#44 @ `ddb678e` | Repo **public** at https://github.com/m-cahill/ezra (2026-05-07). Records: `M40_plan_merge.md`, `M40_run1.md`, `M40_visibility_record.md`. M39 **GO WITH DOCUMENTED LIMITATIONS** unchanged. No new tag/release/PyPI/Pages in visibility step. |
